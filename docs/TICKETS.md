...
## T-026 [P1] ฟอร์มตั้งเกณฑ์เตือนจาก UI — blocked (รอ T-024)
...
## T-025 [P1] UI แจ้งเตือน — toast ขวาล่าง + สถานะค้างบนการ์ด — blocked (รอ T-024)
...
## T-024 [P1] backend ของ alarm — เกณฑ์ + ตัดสินที่ ingest + ส่งขึ้นจอ — doing
...
progress:   2026-09-11 โค้ดครบทุกส่วน: schema 4 คอลัมน์ + migration `0003` · `ingest/alarm.ts`
            ...
            ⏳ **ยังไม่ได้เทสส่วน DB + SSE** — Docker Desktop ปิดอยู่ (เครื่องขึ้นวันใหม่) migration
            ยังไม่ได้ apply ; done-when ข้อที่ต้องยิง MQTT จริงยังค้าง
