...
- 🔴 **ฟิลด์ที่ SSE ไม่ได้ส่งมาด้วยจะค้างที่ค่าตอนโหลดหน้า** — พลาดมาแล้ว **2 ครั้ง**
  (`last_frame_at` ใน T-006 · `received_at` ใน T-012) ทั้งคู่ให้ผลเหมือนกันคือตัวเลขบนจอ
  ดูสมเหตุสมผลแต่ผิด และผิดมากขึ้นเรื่อย ๆ ตามเวลาที่เปิดหน้าไว้ ซึ่งจับได้ยากกว่าค่าที่ผิดชัด ๆ
  · **กติกา: ฟิลด์ไหนที่หน้าเว็บเอามาคำนวณต่อ ต้องมากับ event ทุกครั้ง อย่าให้ client เดา**
