...
3. **T-030 → T-029 → T-028** สินค้าระดับตัวถูก (เคาะแล้วที่ **D-024**) — เรียงแบบนี้เพราะ
   T-030 นิยาม topic ภาพดิบ ซึ่ง T-029 ต้องใช้กันไม่ให้ ingest กิน แล้ว T-028 ถึงวัดได้บนของจริง
   ; ✅ **T-027 ปิดแล้ว** ข้อสรุปสำคัญ: D-020 "edge นอกขอบเขต" **ยังจริง** แค่ย้ายจาก
   "คนละเครื่อง" เป็น "คนละ process" — ไม่ต้องรื้อ T-015/T-017/T-018
4. **T-024 → T-025 → T-026** ระบบแจ้งเตือนค่าเกินเกณฑ์ (design เสร็จแล้วที่ D-023)
   — ไม่ขึ้นกับสาย 2 ระดับ ทำคู่ขนานได้
