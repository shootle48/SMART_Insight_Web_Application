...
`docs/mock/theme-mock.html` + `docs/mock/gauge.jpg` — เปิดจาก `file://` ได้ ไม่ต้องต่อเน็ต
(**copy ทั้งโฟลเดอร์** ไม่งั้นภาพหาย) · สลับเทียบได้ 8 คู่:
**ธีมมืด (ของจริงตอนนี้) / ธีมสว่าง (ref ใหม่)** × **การ์ดเดิม / การ์ดใหม่** × **ภาพจากกล้อง / เกจที่วาดเอง**
`gauge.jpg` = `../../bench/overlay/pass_bp_gauge_f00800.png` แปลงเป็น JPEG (302KB → 34KB)
