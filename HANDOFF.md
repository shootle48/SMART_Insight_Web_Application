...
✅ **หนี้ deploy ปิดแล้ว** (เดิมเป็นข้อ 1 ของลิสต์นี้) — ตอนนี้ไม่มีโค้ดค้างบนเครื่อง dev
ที่ Pi ยังไม่มี ; เกณฑ์ข้อ 1 ของ §0 จึงว่างลง ลิสต์เลื่อนขึ้นทั้งกอง
...
2. **T-016 / T-017** — เคาะอย่างเดียว ไม่ต้องเขียนโค้ด
3. **T-019 / T-020** — ใบเล็กจบในรอบเดียว ไว้แทรกตอนล้าหรือรออะไรอยู่
4. push 6 commit ที่ค้าง (docs/tooling ล้วน ไม่เร่ง)
